...
class RCP:
    ...
    def rcp(self):
        ...
        while True:
            ...
            if me not in HAND_ALIAS:
                print("가위/바위/보 중에서 입력하세요.")
                continue

            you = rand.choice(list(HAND_ALIAS.keys()))
...
class menu:
    def __init__(self):
        self.rcp_game = RCP()
        self.rsp_game = RockPaperScissors()
    ...
    def hist_menu(self):
        while True:
            ...
            if menu == "1":
                ...
                return self.hist_rsp(self.win_hist, self.lose_hist)
            else:
                break
